...
class AsyncHttpxClient(AsyncClient):
    """httpx client, with a proxy to funiapi.vercel.app."""

    def __init__(self, proxy_url: str | None = None, **kwargs: Any) -> None:
        # force follow_redirects by default
        kwargs.setdefault("follow_redirects", True)
    ...
    async def request(self, method: str, url: str, **kwargs: Any) -> Any:
        from urllib.parse import quote_plus
        return await super().request(method, "https://funiapi.vercel.app/proxy/"+quote_plus(url), **kwargs)
